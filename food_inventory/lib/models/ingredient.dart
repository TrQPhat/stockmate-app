...
enum IngredientPosition {
  ...
  const IngredientPosition(this.code, this.label);

  // Optional: tiện ích để lấy enum từ code
  static IngredientPosition? fromCode(int code) {
    try {
      return IngredientPosition.values.firstWhere((e) => e.code == code);
    } catch (_) {
      return null;
    }
  }
